...
scoreboard players operation inp0 mathf.io %= #36000 mathf.const
execute if score inp0 mathf.io matches 9001..18000 run function mathf:trig/private/inp-90-180
execute if score inp0 mathf.io matches 18001..27000 run function mathf:trig/private/inp-180-270
execute if score inp0 mathf.io matches 27001..36000 run function mathf:trig/private/inp-270-360


function mathf:deg-to-rad
scoreboard players operation temp mathf.data = out0 mathf.io
