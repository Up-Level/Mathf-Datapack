...
scoreboard players operation sqrtValue mathf.data = inp0 mathf.io
scoreboard players operation sqrtValue mathf.data /= out0 mathf.io
scoreboard players operation sqrtValue mathf.data += out0 mathf.io
scoreboard players operation sqrtValue mathf.data /= #2 mathf.const
scoreboard players operation out0 mathf.io = sqrtValue mathf.data
